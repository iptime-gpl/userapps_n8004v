...
static void
init(struct ipt_entry_match *match)
{
...
{
	if (!flags)
		xtables_error(PARAMETER_PROBLEM, "You must specify either `--srcpool or --dstpool'");
}
