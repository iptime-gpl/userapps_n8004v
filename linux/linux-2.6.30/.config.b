...
# CONFIG_ARCH_CPU_RADIAX is not set
CONFIG_ARCH_CPU_SLEEP=y
CONFIG_ARCH_CPU_ULS=y
# CONFIG_ARCH_CPU_LLSC is not set
...
#
CONFIG_RTL_8196E_GW=y
# CONFIG_RTL_8196E_AP is not set
# CONFIG_RTL_NFJROM_MP is not set
CONFIG_RTL_SDRAM_GE_32M=y
...
CONFIG_AUTO_PCIE_PHY_SCAN=y
# CONFIG_RTL_FLASH_DUAL_IMAGE_ENABLE is not set
# CONFIG_USB3G_SUPPORT is not set
# CONFIG_RTL_USB_IP_HOST_SPEEDUP is not set
# CONFIG_RTL_USB_ISOCHRONOUS_WEIGHT is not set
# CONFIG_HTTP_FILE_SERVER_SUPPORT is not set

#
# Support two spi flash
#
# CONFIG_RTL_TWO_SPI_FLASH_ENABLE is not set
CONFIG_RTL_FLASH_MAPPING_ENABLE=y

#
# Flash size 2M or 4M, default 2M
#
CONFIG_RTL_FLASH_SIZE=0x400000
...
#
CONFIG_RTL_ROOT_IMAGE_OFFSET=0x130000
...
#
# CONFIG_ROOTFS_RAMFS is not set
CONFIG_ROOTFS_SQUASH=y
...
CONFIG_CPU_RLX4181=y
CONFIG_CPU_HAS_SLEEP=y
...
# CONFIG_RTL_PPPOE_DIRECT_REPLY is not set
# CONFIG_FAST_PATH_SPI_ENABLED is not set
# CONFIG_RTL_FASTBRIDGE is not set
# CONFIG_SUPPORT_RUSSIA_FEATURES is not set
...
# CONFIG_IPCONFLICT_DETECT is not set
# CONFIG_FORWARD_SPEED_UP_PATCH is not set
# CONFIG_EMBEDDED_TCP_MSS_PMTU_PATCH is not set
# CONFIG_PASSTHROUGH_ALL_CHAIN is not set
# CONFIG_DRIVERLEVEL_REAL_IPCLONE is not set
# CONFIG_IP_ROUTING_CACHE_LIMIT is not set
...
#
CONFIG_RTL_NF_CONNTRACK_GARBAGE_NEW=y
# CONFIG_NETFILTER_NETLINK_QUEUE is not set
# CONFIG_NETFILTER_NETLINK_LOG is not set
# CONFIG_IP_CONNTRACK_LIMIT_CONTROL is not set
# CONFIG_IP_CONNTRACK_LIMIT_PER_IP is not set
CONFIG_UDP_CONN_MAX_SIZE=2048
CONFIG_ICMP_CONN_MAX_SIZE=50
...
# CONFIG_NF_CONNTRACK_L2TP is not set
CONFIG_NF_CONNTRACK_PPTP=y
# CONFIG_NF_CONNTRACK_SANE is not set
CONFIG_NF_CONNTRACK_SIP=y
# CONFIG_NF_CONNTRACK_TFTP is not set
# CONFIG_NF_CONNTRACK_BNET is not set
# CONFIG_RTL_BATTLENET_ALG is not set
...
# CONFIG_NETFILTER_XT_TARGET_NETDETECT is not set
# CONFIG_NETFILTER_XT_TARGET_HAIRPIN is not set
...
# CONFIG_NETFILTER_XT_MATCH_VLAN is not set
# CONFIG_NETFILTER_XT_MATCH_PHYPORT is not set
...
# CONFIG_NETFILTER_XT_MATCH_IPPOOL is not set
...
CONFIG_STP=y
CONFIG_BRIDGE=y
# CONFIG_RTL_STP is not set
CONFIG_RTL_WLAN_BLOCK_RELAY=y
# CONFIG_RTL_HW_STP is not set
# CONFIG_PORT_BASED_VLAN_FEATURE is not set
...
# CONFIG_SLOT_0_92C is not set
# CONFIG_SLOT_0_92D is not set
CONFIG_SLOT_0_88E=y
# CONFIG_SLOT_0_8812 is not set
# CONFIG_SLOT_0_8812AR_VN is not set
# CONFIG_SLOT_0_EXT_PA is not set
# CONFIG_SLOT_0_ANT_SWITCH is not set
CONFIG_RTL_88E_SUPPORT=y
CONFIG_RTL8190_PRIV_SKB=y
CONFIG_RTL_VAP_SUPPORT=y
CONFIG_RTL_CLIENT_MODE_SUPPORT=y
CONFIG_RTL_REPEATER_MODE_SUPPORT=y
# CONFIG_RTL_MULTI_REPEATER_MODE_SUPPORT is not set
# CONFIG_RTL_802_1X_CLIENT_SUPPORT is not set
...
# CONFIG_RTL_HS2_SUPPORT is not set
# CONFIG_RTL_SIMPLE_CONFIG is not set
...
# CONFIG_PPP_IDLE_TIMEOUT_REFINE is not set
CONFIG_PPPOE=y
...
#
# CONFIG_RTL865X_KERNEL_MIPS16 is not set

#
# Config Optional MIPS16-Inst Option for Kernel Modules
#

#
# Config Optional MIPS16-Inst Option for Device Drivers
#

#
# Config for Layered Driver Features
#
CONFIG_RTL_LAYERED_DRIVER=y
...
#
CONFIG_RTL_EXTPORT_VLANID=9

#
# Choose hardware features.
#
# CONFIG_RTL_HW_NAPT is not set
CONFIG_RTL_HW_MULTICAST_ONLY=y
# CONFIG_RTL_HW_L2_ONLY is not set
...
# CONFIG_RTL_IPTABLES_RULE_2_ACL is not set
# CONFIG_RTL_FAST_FILTER is not set
CONFIG_RTL865X_MBUF_HEADROOM=128
CONFIG_RTL_ETH_PRIV_SKB=y
CONFIG_RTL_ETH_PRIV_SKB_DEBUG=y
CONFIG_EXTRTL8212_PHYID_P1=18
CONFIG_EXTRTL8212_PHYID_P3=20
CONFIG_EXTRTL8212_PHYID_P5=22
CONFIG_RTL_HARDWARE_MULTICAST=y
# CONFIG_RTL_HARDWARE_MULTICAST_CAM is not set
# CONFIG_RTL_PROC_DEBUG is not set
# CONFIG_RTL_LOG_DEBUG is not set
# CONFIG_RTL865X_ROMEPERF is not set
CONFIG_RTK_VLAN_SUPPORT=y
# CONFIG_RTK_VLAN_WAN_TAG_SUPPORT is not set
# CONFIG_RTK_VLAN_FOR_CABLE_MODEM is not set
CONFIG_RTK_VLAN_NEW_FEATURE=y
# CONFIG_RTL_UNKOWN_UNICAST_CONTROL is not set
CONFIG_RTL_EEE_DISABLED=y
CONFIG_RTL_REINIT_SWITCH_CORE=y
# CONFIG_RTL_SOCK_DEBUG is not set
# CONFIG_EFM_KT_3WAN_PORTS is not set
# CONFIG_RTL_96E_GPIOB5_RESET is not set
# CONFIG_RTL8686_GMAC is not set
...
CONFIG_CMDLINE="console=ttyS0,38400 root=/dev/mtdblock1"
...
CONFIG_CRYPTO_HW=y
# CONFIG_CRYPTO_DEV_REALTEK is not set
...
CONFIG_HAS_DMA=y
CONFIG_NLATTR=y
# CONFIG_EFM_EXTENDER is not set
