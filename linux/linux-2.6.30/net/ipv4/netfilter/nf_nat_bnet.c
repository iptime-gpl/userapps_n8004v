...
#define NF_CT_DUMP_TUPLE nf_ct_dump_tuple
			 ...
			 char *bnet_data)
{
	...
	NF_CT_DUMP_TUPLE(&ct_tuple);
        ...
        tuple_hash = nf_conntrack_find_get(dev_net(indev), &ct_tuple);
	...
	tuple_hash = NULL;
        ...
        for (i=0; !tuple_hash && i < nf_conntrack_htable_size; i++)
        {
