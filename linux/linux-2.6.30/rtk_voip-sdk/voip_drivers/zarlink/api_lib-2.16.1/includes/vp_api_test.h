...
typedef enum {
    ...
    VP_TEST_STATUS_TEST_NOT_SUPPORTED, /**< Requested test is not supported
    ...
    VP_TEST_STATUS_VA_OOR,          /**< Measured Voltage is out-of-range */
    VP_TEST_STATUS_VB_OOR,          /**< " " */
    VP_TEST_STATUS_IMTOFFSET_OOR,
    VP_TEST_STATUS_BUF_OVERFLOW,    /* test would exceed the buffer storage available */
    VP_TEST_STATUS_NUM_TYPES,       /**< NOT an ERROR, Just used for coding
                                     * purposes */
...
typedef enum {
    ...
    VP_LOOP_COND_TEST_VSAG,
    VP_LOOP_COND_TEST_VSBG,
