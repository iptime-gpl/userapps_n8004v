...
#define EXT_2G_WPS_BT  	3  /* E3 */ 
#define EXT_2G_GPIO_BIT (0x1<<EXT_2G_WPS_BT)
#define EXT_5G_WPS_BT  4  /* E4 */
#define EXT_5G_GPIO_BIT (0x1<<EXT_5G_WPS_BT)
...
int ext_2g_led_op = RUN_LED_OFF;
int ext_5g_led_op = RUN_LED_OFF;

int ext_led_operation(int gpio, int op, int count)
{
	if(op == RUN_LED_ON)
	{
		set_led_op(gpio,1);
...
static void rtl_wps_timer(unsigned long data)
{
	...
	{
		ext_led_operation(EXT_2G_WLAN_GPIO,ext_2g_led_op,led_run_count);
		ext_led_operation(EXT_5G_WLAN_GPIO,ext_5g_led_op,led_run_count);

                if(check_ext2g_wps_bt() || check_ext5g_wps_bt())
                {
