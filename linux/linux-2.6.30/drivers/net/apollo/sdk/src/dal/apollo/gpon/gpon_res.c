...
int32 gpon_dev_initialize(gpon_dev_obj_t* obj, uint32 baseaddr)
{
    ...
    osal_memcpy(&obj->serial_number.vendor[0], "CIGG", RTK_GPON_VENDOR_ID_LEN);
    obj->serial_number.specific[0] = 0x98;
    obj->serial_number.specific[1] = 0x76;
    obj->serial_number.specific[2] = 0x54;
    obj->serial_number.specific[3] = 0x32;
