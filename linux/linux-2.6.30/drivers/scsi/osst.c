/*
  ...
  $Header: /usr/kcvsrep/RTL3.4/rtl819x/linux-2.6.30/drivers/scsi/osst.c,v 1.1.1.1 2013/03/19 08:37:07 rtlac Exp $
...
static const char * cvsid = "$Id: osst.c,v 1.1.1.1 2013/03/19 08:37:07 rtlac Exp $";
